      ...
      <div className="province-modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div className="modal-search-box">
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-pure-grey" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
